...
def index():
    ...
    if labname is not None:
        ...
        pagination = label.blogs.order_by(Blog.create_at.desc()).paginate(page, per_page=current_app.config[
...
def blog(id):
    ...
    return render_template('blog.html', blog=blog, comments=comments, pagination=pagination, form=form, page=page)
